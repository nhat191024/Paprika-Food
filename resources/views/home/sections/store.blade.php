...
<section class="flex w-full justify-center bg-white px-8 py-24 dark:bg-zinc-950">
    <div class="grid w-full max-w-7xl grid-cols-1 items-center gap-16 md:grid-cols-2">
        <div class="w-full overflow-hidden rounded-xl shadow-lg" data-animate="fade-right">
        ...
        <div class="flex flex-col gap-6" data-animate="fade-left">
            ...
            <div class="mt-6">
                <a href="{{ route('contact') }}" wire:navigate class="inline-flex items-center justify-center border-none bg-[#f00028] font-bold tracking-wide text-white shadow-md hover:bg-red-700 uppercase px-8 py-4 rounded-xl transition-colors">
