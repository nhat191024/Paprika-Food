...
<section class="flex w-full flex-col items-center border-t border-zinc-200 bg-[#eeeeee] px-8 py-20 dark:border-zinc-800 dark:bg-zinc-900">
    <div class="w-full max-w-7xl text-center">
        ...
        <div class="mb-12 grid grid-cols-2 gap-6 md:grid-cols-4">
            <a href="{{ route('menu') }}" wire:navigate class="group cursor-pointer overflow-hidden rounded-xl border-none p-0 reveal-on-scroll opacity-0 translate-y-8 bg-white dark:bg-zinc-800">
            ...
            <a href="{{ route('menu') }}" wire:navigate class="group cursor-pointer overflow-hidden rounded-xl border-none p-0 reveal-on-scroll opacity-0 translate-y-8 animation-delay-100 bg-white dark:bg-zinc-800">
                <div class="relative aspect-square overflow-hidden bg-zinc-100 dark:bg-zinc-800">
            ...
            <a href="{{ route('menu') }}" wire:navigate class="group cursor-pointer overflow-hidden rounded-xl border-none p-0 reveal-on-scroll opacity-0 translate-y-8 animation-delay-200 bg-white dark:bg-zinc-800">
                <div class="relative aspect-square overflow-hidden bg-zinc-100 dark:bg-zinc-800">
            ...
            <a href="{{ route('menu') }}" wire:navigate class="group cursor-pointer overflow-hidden rounded-xl border-none p-0 reveal-on-scroll opacity-0 translate-y-8 animation-delay-300 bg-white dark:bg-zinc-800">
                <div class="relative aspect-square overflow-hidden bg-zinc-100 dark:bg-zinc-800">
        ...
        <a href="{{ route('menu') }}" wire:navigate class="inline-flex items-center justify-center border-none bg-[#ffae00] font-bold tracking-wide text-[#1A1A1A] shadow-md uppercase hover:bg-yellow-500 rounded-full px-10 py-3 text-lg transition-colors">
