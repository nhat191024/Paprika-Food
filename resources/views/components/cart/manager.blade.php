            ...
            <div class="flex-1 overflow-y-auto p-6">
                ...
                <template x-for="item in cart.items" :key="item.key">
                    <div class="flex gap-4 border-b border-zinc-100 py-5 last:border-0 dark:border-zinc-800">
                        <div class="size-20 shrink-0 overflow-hidden rounded-2xl bg-zinc-100 dark:bg-zinc-900 relative flex items-center justify-center">
                            <template x-if="item.image">
                                <div class="relative size-full flex items-center justify-center">
                                    <img :src="item.image" :alt="item.name" class="size-full object-contain" x-on:error="$el.style.display='none'; $el.nextElementSibling.style.display='flex'">
                                    <div class="hidden size-full items-center justify-center">
                                        <svg class="size-8 text-zinc-300 dark:text-zinc-700" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
